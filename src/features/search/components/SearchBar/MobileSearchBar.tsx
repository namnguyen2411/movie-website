    ...
    <div className="flex h-[80px] flex-1 items-center space-x-4 xl:hidden">
      <div className="relative flex flex-1 items-center rounded-md bg-[#ffffff14]">
        ...
        <Input
          ...
          className="w-full border-transparent py-5 pl-12 pr-4 transition-all duration-300 placeholder:text-white hover:border-white focus:border-white 2xl:w-[380px]"
        />
      </div>
